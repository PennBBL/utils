...
if (exists("testing")){
      ...
      qa_path<-"/import/monstrum/eons_xnat/redcap/imaging_variables/n1601_asl_automated_QA_4_9_15.csv"
      #out_path<-"~/ASL_QA_test_data.csv"
      out_path<-"/import/monstrum/eons_xnat/redcap/imaging_variables/n1601_asl_excludes_4_9_15.csv"
      #visual_qa<-"/import/monstrum/eons2_xnat/redcap/imaging/n404_asl_visual_QA.csv"
      visual_qa<-"/import/monstrum/eons_xnat/redcap/imaging_variables/n1601_asl_visual_QA_4_9_15.csv"
...
qa_data$coverage_flag[which(qa_data$zeros_in_mask > 200)]<-1 ###flag participants w/ > 200 empty voxels in group mask
...
qa_data$mean_intensity_flag[which(qa_data$mean_intensity < 40)]<-1 ###flag participants w/ less that 30 mean cbf
qa_data$mean_intensity_flag[which(qa_data$mean_intensity > 90)]<-1 ###flag participants w/ greater than 80 mean cbf
