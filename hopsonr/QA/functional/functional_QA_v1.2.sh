...
[ $overwrite == 1 ] && echo bblid,scanid,user,hostname,version,no_data_collected,missing_processed_data_exclude,meanrel,maxrel,tsnr,zeros_in_mask,voxels_out_of_mask,fslcc,$measure_head > $out_path
echo bblid,scanid,user,hostname,version,no_data_collected,missing_data,meanrel,maxrel,tsnr,zeros_in_mask,voxels_out_of_mask,fslcc,$measure_head
